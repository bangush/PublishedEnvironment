Type.registerNamespace("Alchemy.Plugins.PublishedEnvironment.Views");

Alchemy.Plugins.PublishedEnvironment.Views.PublishedEnvironment = function PublishedEnvironment() {
    Tridion.OO.enableInterface(this, "Alchemy.Plugins.PublishedEnvironment.Views.PublishedEnvironment");
    this.addInterface("Tridion.Cme.View");
};

Alchemy.Plugins.PublishedEnvironment.Views.PublishedEnvironment.prototype.initialize = function PublishedEnvironment$initialize() {
...
$display.registerView(Alchemy.Plugins.PublishedEnvironment.Views.PublishedEnvironment);